...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!preg_match('#^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*\W)#', $mdp_utilisateur)) {
        $erreurs['mdp_utilisateur'] = "Votre mot de passe doit contenir un chiffre, une minuscule, une majuscule et un caractère spécial";
        $erreurs['mdp_verification'] = "Votre mot de passe doit contenir un chiffre, une minuscule, une majuscule et un caractère spécial";
    }
